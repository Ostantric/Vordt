...
const char* ssid     = "Vordt";
const char* password = "vordt1234";
      ...
      switch (incomingbyte0) {
        case 1 :
          ...
          if (incomingbyte1 == 1) { //Position Notation
              ...
              #endif
              delay(0.1);
              xTaskCreate(Position_UDP_Send,"Position_UDP_Send",5000,sendtotask,3,NULL);
          }
              ...
              #endif
              delay(0.1);
              xTaskCreate(Velocity_UDP_Send,"Velocity_UDP_Send",5000,sendtotask,3,NULL);
          }
              ...
              #endif
              delay(0.1);
              xTaskCreate(Turn_UDP_Send,"Turn_UDP_Send",5000,sendtotask,3,NULL);
          }
              ...
              #endif
              delay(0.1);
              xTaskCreate(Motor_Voltage_UDP_Send,"Motor_Voltage_UDP_Send",5000,sendtotask,3,NULL);
          }
          else{
              //xSemaphoreGive(FPGA_Serial_Write_Semaphore);
          }
