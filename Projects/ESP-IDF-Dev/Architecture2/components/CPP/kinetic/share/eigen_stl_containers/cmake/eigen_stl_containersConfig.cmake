...
if("FALSE" STREQUAL "TRUE")
  set(eigen_stl_containers_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-eigen-stl-containers-0.1.8)
  set(eigen_stl_containers_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-eigen-stl-containers-0.1.8/obj-x86_64-linux-gnu/devel)
...
if(NOT "include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_stl_containers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
