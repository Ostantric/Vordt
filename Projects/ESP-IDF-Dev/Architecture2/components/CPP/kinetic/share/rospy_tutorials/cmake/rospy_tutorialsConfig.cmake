...
if("FALSE" STREQUAL "TRUE")
  set(rospy_tutorials_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rospy-tutorials-0.7.1)
  set(rospy_tutorials_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rospy-tutorials-0.7.1/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rospy_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
