...
if("FALSE" STREQUAL "TRUE")
  set(turtlesim_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-turtlesim-0.7.1)
  set(turtlesim_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-turtlesim-0.7.1/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlesim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
