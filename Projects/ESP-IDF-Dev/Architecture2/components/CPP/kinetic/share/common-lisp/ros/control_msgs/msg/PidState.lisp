...
(cl:defmethod cl:initialize-instance :after ((m <PidState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PidState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_msgs-msg:<PidState> is deprecated: use control_msgs-msg:PidState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PidState>))
...
(cl:defmethod timestep-val ((m <PidState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:timestep-val is deprecated.  Use control_msgs-msg:timestep instead.")
  (timestep m))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <PidState>))
...
(cl:defmethod error_dot-val ((m <PidState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:error_dot-val is deprecated.  Use control_msgs-msg:error_dot instead.")
  (error_dot m))

(cl:ensure-generic-function 'p_error-val :lambda-list '(m))
(cl:defmethod p_error-val ((m <PidState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:p_error-val is deprecated.  Use control_msgs-msg:p_error instead.")
  (p_error m))

(cl:ensure-generic-function 'i_error-val :lambda-list '(m))
(cl:defmethod i_error-val ((m <PidState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:i_error-val is deprecated.  Use control_msgs-msg:i_error instead.")
  (i_error m))

(cl:ensure-generic-function 'd_error-val :lambda-list '(m))
(cl:defmethod d_error-val ((m <PidState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:d_error-val is deprecated.  Use control_msgs-msg:d_error instead.")
  (d_error m))

(cl:ensure-generic-function 'p_term-val :lambda-list '(m))
(cl:defmethod p_term-val ((m <PidState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:p_term-val is deprecated.  Use control_msgs-msg:p_term instead.")
  (p_term m))

(cl:ensure-generic-function 'i_term-val :lambda-list '(m))
(cl:defmethod i_term-val ((m <PidState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:i_term-val is deprecated.  Use control_msgs-msg:i_term instead.")
  (i_term m))

(cl:ensure-generic-function 'd_term-val :lambda-list '(m))
(cl:defmethod d_term-val ((m <PidState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:d_term-val is deprecated.  Use control_msgs-msg:d_term instead.")
  (d_term m))

(cl:ensure-generic-function 'i_max-val :lambda-list '(m))
(cl:defmethod i_max-val ((m <PidState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:i_max-val is deprecated.  Use control_msgs-msg:i_max instead.")
  (i_max m))

(cl:ensure-generic-function 'i_min-val :lambda-list '(m))
(cl:defmethod i_min-val ((m <PidState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:i_min-val is deprecated.  Use control_msgs-msg:i_min instead.")
  (i_min m))

(cl:ensure-generic-function 'output-val :lambda-list '(m))
(cl:defmethod output-val ((m <PidState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:output-val is deprecated.  Use control_msgs-msg:output instead.")
  (output m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PidState>) ostream)
  "Serializes a message object of type '<PidState>"
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'header) ostream)
  (cl:let ((__sec (cl:floor (cl:slot-value msg 'timestep)))
        (__nsec (cl:round (cl:* 1e9 (cl:- (cl:slot-value msg 'timestep) (cl:floor (cl:slot-value msg 'timestep)))))))
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'error_dot))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PidState>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    (cl:let ((__sec 0) (__nsec 0))
      ...
      (cl:setf (cl:slot-value msg 'timestep) (cl:+ (cl:coerce __sec 'cl:double-float) (cl:/ __nsec 1e9))))
    (cl:let ((bits 0))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'error_dot) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PidState>)))
  ...
  (cl:format cl:nil "Header header~%duration timestep~%float64 error~%float64 error_dot~%float64 p_error~%float64 i_error~%float64 d_error~%float64 p_term~%float64 i_term~%float64 d_term~%float64 i_max~%float64 i_min~%float64 output~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PidState)))
  "Returns full string definition for message of type 'PidState"
  (cl:format cl:nil "Header header~%duration timestep~%float64 error~%float64 error_dot~%float64 p_error~%float64 i_error~%float64 d_error~%float64 p_term~%float64 i_term~%float64 d_term~%float64 i_max~%float64 i_min~%float64 output~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
