...
if("FALSE" STREQUAL "TRUE")
  set(tf_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-tf-1.11.9)
  set(tf_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-tf-1.11.9/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
