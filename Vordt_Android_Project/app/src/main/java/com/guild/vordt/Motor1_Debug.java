...
public class Motor1_Debug extends FragmentActivity implements client.TaskCallbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.motor1_debug);
        velocity_status=0;
        ...
        position_slider.setEndTrackingListener(new Function0<Unit>() {
            ...
            public Unit invoke() {
                ...
                if (current_turn>0) {
                    mClient.send_command(1,"position", (int) (position_slider.getPosition() * position_total));
                }
                else if (current_turn<0){
                    mClient.send_command(1,"position", (int) (position_slider.getPosition() * position_total)-32767);
                }
                else{
                    mClient.send_command(1,"position", (int) (position_slider.getPosition() * position_total) - 32767);
                }
        ...
        turn_slider.setEndTrackingListener(new Function0<Unit>() {
            ...
            public Unit invoke() {
                Log.e("E", "setEndTrackingListener");
                mClient.send_flag(true);
                mClient.send_command(1,"turn", (int)(turn_slider.getPosition()*turn_total)-50 );
                return Unit.INSTANCE;
            }
        });
        ...
        velocity_slider.setEndTrackingListener(new Function0<Unit>() {
            ...
            public Unit invoke() {
                Log.e("E", "setEndTrackingListener");
                mClient.send_flag(true);
                mClient.send_command(1,"velocity", (int)(velocity_slider.getPosition()*velocity_total)+10);
                return Unit.INSTANCE;
            }
        });
    ...
    public void onLostConnection() {
        ...
        Toast.makeText(this, "VORDT Connection Lost!", Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onDisconnected() {
        if (DEBUG) Log.i(TAG, "onDisconnected()");
        Toast.makeText(this, "Disconnected from VORDT!", Toast.LENGTH_SHORT).show();
    }
